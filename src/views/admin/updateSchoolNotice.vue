      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <el-button type="success" @click="updateSchoolNotice">修改</el-button>
            </td>
          </tr>
        </tbody>
      </table>
...
export default {
  ...
  methods: {
    ...
    updateSchoolNotice () {
      this.$axios.post('http://127.0.0.1:3000/admin/updateSchoolNotice', {
        params: {
          title: this.title,
  ...
  mounted () {
    ...
    var that = this
    this.$axios.post('http://127.0.0.1:3000/admin/getSingleSchoolNotice', {
      params: {
        ID: this.ID
      }
    }).then(res => {
